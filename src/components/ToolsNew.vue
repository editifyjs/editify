<template>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a @click="changeNew('text')"
        ><i class="fas fa-text-width"></i><span>Text<small>New</small></span></a
      >
      <a @click="changeNew('blockquote')"
        ><i class="fas fa-quote-left"></i
        ><span>Quote<small>New</small></span></a
      >
        ...
        <div class="modal__dialog" :class="{ active: active }">
          <div class="modal__content">
            ...
            <div class="modal__footer">
              <button class="button" @click="setCodeNew('code')">
                Complate
              </button>
            </div>
          </div>
      ...
      <a
        ...
        ><span>Save<small>ctrl/enter</small></span></a
      >
    </div>
  </div>
</template>
